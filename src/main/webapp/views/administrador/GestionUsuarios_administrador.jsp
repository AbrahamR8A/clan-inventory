...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function mostrarAlertaCopiado() {
            ...
            alerta.innerHTML = '<i class="fas fa-check-circle mr-2"></i> Correo copiado';
            alerta.style.position = "fixed";
            alerta.style.bottom = "25px";
            alerta.style.right = "25px";
            alerta.style.zIndex = "9999";
            alerta.style.backgroundColor = "#1cc88a";
        ...
        document.addEventListener("click", function (event) {
            ...
            copiarTexto(correo.trim()).then(function () {

                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-admin">Acciones de Ingreso</h6>
                                </div>
                                <div class="card-body text-center py-4">
                                    <i class="fas fa-clipboard-list fa-3x mb-3 text-gray-300"></i>
                                    <p class="text-dark mb-4">Revise los materiales y confirme la recepción en el sistema. Los inventarios serán actualizados automáticamente.</p>
                                    ...
                                    <div class="mt-4">
                                        <a href="${pageContext.request.contextPath}/OrdenIngresoServlet?action=pendientes" class="btn btn-outline-secondary btn-block">
